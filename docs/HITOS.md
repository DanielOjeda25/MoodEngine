...
**🏁 14/44 hitos de Fase 2 hechos.** Próximo: F2H16 (limpieza HistoryStack — múltiples acciones del editor no registradas en el stack: drops de textura/material, edits del UV editor, etc.). Después F2H17 (Face Mode estilo Hammer = selección visual de cara individual + UV per-cara).

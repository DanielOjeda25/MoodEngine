...
**🏁 20/44 hitos de Fase 2 hechos.** Próximo: **F2H22 — 4-viewport Hammer-style layout** (anotado como candidato en `PENDIENTES.md` post-F2H20, charlado con el dev: 1 perspectiva 3D + 3 ortográficas top/front/side en wireframe con grid + drag-edit entre vistas). Plan F2 original aquí entraba en sub-fase 2.3 (SSAO/SSR/bloom/CSM); el rerouting prioriza workflow del dev sobre features visuales.

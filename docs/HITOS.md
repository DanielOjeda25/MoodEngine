...
**🏁 Sub-fase 2.1 (cimientos) cerrada con `v1.1.7-fase2-hito10`.** 9/44 hitos de Fase 2 hechos (F2H9 docs públicas postergado). Próximo paso: sub-fase 2.2 (CSG / editor de niveles serio, F2H11+) o F2H9 docs.

...
**🏁 15/44 hitos de Fase 2 hechos.** Próximo: F2H17 (Face Mode estilo Hammer = selección visual de cara individual + UV per-cara — el feature que el dev pidió explícitamente "lo quiero igual que el hammer"). Después F2H18 (compilación brush → mesh estática unificada al guardar el mapa).

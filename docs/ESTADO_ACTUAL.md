...
### Sub-fase 3.4 — Editor pro (EN CURSO, 2/6 — reorden 2026-05-27 con Properties Editor insertado)
...
**Próximo hito:**
- 🔲 **F3H22** — Properties Editor con icons laterales (Blender style). Plan stub en [`PLAN_HITO_F3H22.md`](PLAN_HITO_F3H22.md). Promovido del backlog UX al cerrar F3H21 a pedido del dev.

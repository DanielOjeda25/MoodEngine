...
### Sub-fase 3.4 — Editor pro (EN CURSO, 9/11 — F3H28 cierra integración Grupos+Tools al Inspector; F3H29-F3H30 stubs)
...
**Próximo hito:**
- 📝 **F3H29** — Mundo grande (camera limits / far plane / reverse-Z). Split del stub original F3H27, Item 3. Stub pendiente de crear cuando arranque.

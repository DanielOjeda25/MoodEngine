...
### Sub-fase 3.2 — Inspector + Hierarchy pulidos (en curso, 1/6)
...
**Próximo hito:**
- 🔲 **F3H9** — Copy/Paste de components entre entidades. Click derecho en header de component del Inspector → Copiar valores / Pegar valores / Pegar como nuevo. Cross-entity dentro del proyecto. Plan en [`PLAN_HITO_F3H9.md`](PLAN_HITO_F3H9.md).

**Roadmap (~27 hitos):**
```
Sub-fase 3.1 — El editor te respeta              F3H1 ✅ F3H2 ✅ F3H3 ✅ F3H4 ✅ F3H5 ✅ F3H6 ✅ F3H7 ✅   🏁
Sub-fase 3.2 — Inspector + Hierarchy pulidos     F3H8 ✅ F3H9 – F3H13

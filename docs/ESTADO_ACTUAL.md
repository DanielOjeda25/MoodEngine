...
### Sub-fase 3.2 — Inspector + Hierarchy pulidos (en curso, 3/6)
...
**Próximo hito:**
- 🔲 **F3H11** — Cluster de persistencia: agregar `SavedAudio`/`SavedCamera` al EntitySerializer + refactor de `serializeBrush`/`parseBrush` para exponer al header + sumar los 3 al ComponentClipboard. Plan stub en memoria `clipboard-brush-audio-camera`; expandir a `PLAN_HITO_F3H11.md` al arrancar.

**Roadmap (~27 hitos):**
```
Sub-fase 3.1 — El editor te respeta              F3H1 ✅ F3H2 ✅ F3H3 ✅ F3H4 ✅ F3H5 ✅ F3H6 ✅ F3H7 ✅   🏁
Sub-fase 3.2 — Inspector + Hierarchy pulidos     F3H8 ✅ F3H9 ✅ F3H10 ✅ F3H11 – F3H13

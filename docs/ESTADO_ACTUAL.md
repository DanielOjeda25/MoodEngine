...
### Sub-fase 3.1 — El editor te respeta (en curso, 6/7)
...
**Próximo hito:**
- 🔲 **F3H7** — Último hito de Sub-fase 3.1. `UserSettings > Editor` para preferencias per-installation del editor: sensibilidades de cámara (mouse look, pan, zoom), umbrales de click/drag, autosave interval. Cierra la Sub-fase 3.1 — proyecto + instalación quedan ambos configurables sin recompilar. Plan en [`PLAN_HITO_F3H7.md`](PLAN_HITO_F3H7.md).

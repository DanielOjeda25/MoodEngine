...
### Sub-fase 3.1 — El editor te respeta (en curso, 5/7)
...
**Próximo hito:**
- 🔲 **F3H6** — Migración del bucket "Snap" (alta prioridad) a `.moodproj > Snap`. Toma snap steps `{1,2,4,8,16,32,64,128}` + default index 4 + snap-to-vertex thresholds (NDC + broadphase) del bucket 4 del audit. Es el primer bucket de UX del editor (no de gameplay) — el dev cambia esto frecuentemente al modelar. Plan en [`PLAN_HITO_F3H6.md`](PLAN_HITO_F3H6.md).

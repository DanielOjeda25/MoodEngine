...
**Próximo hito:**
- 🔲 **F3H8** — Primer hito de Sub-fase 3.2 "Inspector + Hierarchy pulidos". Multi-edit del Inspector: editar N entidades a la vez (campos con valor común vs mixed `—`), aplicar cambios a toda la selección. F2H23 iter 5 ya entregó multi-edit de Transform vía gizmo; F3H8 lo lleva al Inspector completo. Plan en [`PLAN_HITO_F3H8.md`](PLAN_HITO_F3H8.md).

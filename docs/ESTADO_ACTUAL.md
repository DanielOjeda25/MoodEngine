...
### Sub-fase 3.2 — Inspector + Hierarchy pulidos (en curso, 2/6)
...
**Próximo hito:**
- 🔲 **F3H10** — Plan en [`PLAN_HITO_F3H10.md`](PLAN_HITO_F3H10.md).

**Roadmap (~27 hitos):**
```
Sub-fase 3.1 — El editor te respeta              F3H1 ✅ F3H2 ✅ F3H3 ✅ F3H4 ✅ F3H5 ✅ F3H6 ✅ F3H7 ✅   🏁
Sub-fase 3.2 — Inspector + Hierarchy pulidos     F3H8 ✅ F3H9 ✅ F3H10 – F3H13

...
### Sub-fase 3.1 — El editor te respeta (en curso, 3/7)
...
**Próximo hito:**
- 🔲 **F3H4** — Migración del bucket "Gameplay tier 1" a `.moodproj > Gameplay`. Primer hito de migración real (el chasis de F3H1 empieza a poblarse con fields del usuario). Toma walk/crouch speeds + jump velocity + jump cooldown del bucket 1 del audit; los expone como sección "Gameplay" en el Project Settings panel + reads en ambos call-sites (Player + Editor); test de roundtrip. Cierra naturalmente la consolidación del bug fix de F3H3 (un solo lugar para editar). Plan en [`PLAN_HITO_F3H4.md`](PLAN_HITO_F3H4.md).

**Roadmap (~27 hitos):**
```
Sub-fase 3.1 — El editor te respeta              F3H1 ✅ F3H2 ✅ F3H3 ✅ F3H4-F3H7

...
### Sub-fase 3.2 — Inspector + Hierarchy pulidos (en curso, 5/6)
...
**Próximo hito:**
- 🔲 **F3H13** — Pendiente decidir el bloque. `PLAN_FASE3.md` Sub-fase 3.2 menciona "Reset to default en cada Inspector field". Sub-fase cerraría con este hito (6/6). Plan a definir cuando arranque.

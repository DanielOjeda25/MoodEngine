...
### Sub-fase 3.1 — El editor te respeta (en curso, 4/7)
...
**Próximo hito:**
- 🔲 **F3H5** — Migración del bucket "Character" a `.moodproj > Character`. Toma capsule dimensions + eye height + headbob (freq/amplitude) del bucket 2 del audit. Mismo patrón que F3H4 (struct nested, panel section, reads live en Editor + captura al load en Player). Plan en [`PLAN_HITO_F3H5.md`](PLAN_HITO_F3H5.md).

**Roadmap (~27 hitos):**
```
Sub-fase 3.1 — El editor te respeta              F3H1 ✅ F3H2 ✅ F3H3 ✅ F3H4 ✅ F3H5-F3H7

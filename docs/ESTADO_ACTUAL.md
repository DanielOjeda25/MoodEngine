...
**Sub-fase 3.3 CERRADA 🏁** — el Asset Browser pasa de "lista plana de paths" a "browser con preview 3D + drag&drop visual + validador + rename con cascada". Próxima sub-fase: 3.4 (Viewport pro + Performance + Feedback, 5 hitos consolidados desde 8).

**Próximo hito:**
- 🔲 **F3H20** — Snapping configurable. Plan stub en [`PLAN_HITO_F3H20.md`](PLAN_HITO_F3H20.md).

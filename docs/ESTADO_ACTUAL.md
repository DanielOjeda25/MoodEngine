...
### Sub-fase 3.4 — Editor pro (EN CURSO, 7/8 — F3H26+F3H27 insertados post-F3H25)
...
**Próximo hito:**
- 📝 **F3H27** — Polish UX restante (grupos + tools integrados + parenting jerárquico + mundo grande + HDRI dinámico). Cierra Fase 3. Stub en [`PLAN_HITO_F3H27.md`](PLAN_HITO_F3H27.md).

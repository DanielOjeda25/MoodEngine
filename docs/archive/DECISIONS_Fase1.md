# Log de decisiones técnicas — Fase 1 (Hito 0 → Hito 42)

> **Archivo separado en F2H26 cierre (2026-05-08)**. Las entries
> originales de Fase 1 vivían en `docs/DECISIONS.md`. Ese archivo
> superó las 4000 líneas y se hizo costoso de leer/editar — split
> por fase para mantener el activo manejable.
>
> Entries de **Fase 2 (F2H1+)** y posteriores siguen en
> `docs/DECISIONS.md`.
>
> Formato por entrada: contexto, decisión, razones, alternativas
> descartadas, condiciones de revisión.

# Estado actual del proyecto — histórico

> **Archivo separado en F2H26 cierre (2026-05-08)**. Las secciones
> "F2HN (anterior, ya cerrado)" y "Hito N (anterior)" eran parte de la
> sección 1 de `docs/ESTADO_ACTUAL.md`; ese archivo superó las 1200
> líneas con histórico que ya no se consulta frecuentemente. Split por
> antiguedad: el current state + último cerrado quedan en
> `ESTADO_ACTUAL.md`; este archivo conserva las secciones de hitos
> previos para referencia.
>

...
#include "engine/world/csg/CompileMap.h" // F2H20: handleCompileMap / handleExportObj
#include "engine/world/csg/MapExportObj.h" // F2H20: writeObj
...
// ----------------------------------------------------------------------------
// F2H20: handleCompileMap / handleExportObj — compilacion brush -> mesh
// estatica unificada + export OBJ. La compilacion es on-demand (no se
// persiste en .moodmap, no se usa en el runtime). Sirve para que el dev
// vea las stats post-cull/post-weld + exporte el mapa para herramientas
// externas (Blender, MeshLab).
// ----------------------------------------------------------------------------

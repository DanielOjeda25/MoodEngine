...
// NOTE: drawPauseMenu (Doom-style pause menu) vive en
// `GameOverlay_PauseMenu.cpp` (extraido en AUDIT-1). La declaracion esta
// en GameOverlay_Internal.h y `draw()` lo invoca al final.
...
// NOTE: F2H48 dialog box widget vive en `GameOverlay_DialogBox.cpp`

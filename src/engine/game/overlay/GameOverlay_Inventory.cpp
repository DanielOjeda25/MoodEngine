...
///        Promovido a namespace publico en AUDIT-1 para reuso desde
///        `GameOverlay_InventorySplit.cpp` (sibling file).
...
} // namespace Mood::GameOverlay (re-abrimos anonymous abajo)
...
// NOTE: F2H52 Bloque I container split mode (drawInventorySplit) vive en
// `GameOverlay_InventorySplit.cpp` (extraido en AUDIT-1, 2026-05-17). La
// declaracion esta en GameOverlay_Internal.h.
